...
from src.modules.users.presentation.api.routers import users
...
api_router.include_router(users.authenticated_router, prefix="/users", tags=["Users"])
api_router.include_router(
    users.public_router, prefix="/users", tags=["Users"]
)
api_router.include_router(
    expeditions_auth_router,
    prefix="/expeditions",
    tags=["Expeditions"],
)

api_router.include_router(
    expeditions_chief_router,
    prefix="/chief/expeditions",
    tags=["Chief Expeditions"],
)
